...
app.use(cors({
origin: ['https://alexajovo-c6937.web.app','https://production-build-nginx-kubernetes-git-angularapps-kubernetesml.apps.us-east-1.starter.openshift-online.com'],
credentials: true
}));
...
res.status(200).send({"message":"Data recieved"})
 ...
 {
     console.log("Firebase deploy ng ")
 });
